    ...
    return (
        ...
        >
            <Row>
                ...
                <Menu
                    selectedKeys={Object.keys(current.value)}
                    mode="horizontal"
                ...
                >
                    ...
                    {authState && <Menu.Item key="logout">Log out</Menu.Item>}
                    {!authState && <Menu.Item key="login">Log in</Menu.Item>}
                </Menu>
            </Row>
