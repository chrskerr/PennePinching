    ...
    return (
        <Row>
            <Col>
                ...
                <Row>
                    <Col>
                        {current.matches({ analytics: "summary" }) && (
                            <Summary mealsData={mealsData} who={who} />
                        )}
                        {current.matches({ analytics: "history" }) && (
                            <History mealsData={mealsData} who={who} />
                        )}
                        {current.matches({ analytics: "split" }) && (
                            <Split mealsData={mealsData} who={who} />
                        )}
                        {current.matches({ analytics: "weekdays" }) && (
